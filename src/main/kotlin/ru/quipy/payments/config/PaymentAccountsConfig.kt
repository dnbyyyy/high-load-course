...
@Configuration
open class PaymentAccountsConfig {
    companion object {
    ...
    @Bean
    open fun accountAdapters(paymentService: EventSourcingService<UUID, PaymentAggregate, PaymentAggregateState>): List<PaymentExternalSystemAdapter> {
